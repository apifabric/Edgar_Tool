...
resourcename="edgartool"  # lower case, only
resourcegroup="edgartool_rg"
...
# git clone https://github.com/apilogicserver/edgartool.git
# cd edgartool
...
az group create --name edgartool_rg --location "westus"
az appservice plan create --name myAppServicePlan --resource-group edgartool_rg --sku S1 --is-linux
az container create --resource-group edgartool_rg --name edgartool --image apilogicserver/edgartool:latest --dns-name-label edgartool --ports 5656 --environment-variables 'VERBOSE'='True'  'APILOGICPROJECT_CLIENT_URI'='//edgartool.westus.azurecontainer.io:5656'
