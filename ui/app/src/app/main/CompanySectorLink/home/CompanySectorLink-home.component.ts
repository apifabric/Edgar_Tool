...
@Component({
  selector: 'CompanySectorLink-home',
  templateUrl: './CompanySectorLink-home.component.html',
  styleUrls: ['./CompanySectorLink-home.component.scss']
})
export class CompanySectorLinkHomeComponent implements AfterViewInit {
