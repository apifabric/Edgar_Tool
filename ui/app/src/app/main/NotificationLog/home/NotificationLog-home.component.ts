...
@Component({
  selector: 'NotificationLog-home',
  templateUrl: './NotificationLog-home.component.html',
  styleUrls: ['./NotificationLog-home.component.scss']
})
export class NotificationLogHomeComponent implements AfterViewInit {
