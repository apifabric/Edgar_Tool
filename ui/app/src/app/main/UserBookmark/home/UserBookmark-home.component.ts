...
@Component({
  selector: 'UserBookmark-home',
  templateUrl: './UserBookmark-home.component.html',
  styleUrls: ['./UserBookmark-home.component.scss']
})
export class UserBookmarkHomeComponent implements AfterViewInit {
