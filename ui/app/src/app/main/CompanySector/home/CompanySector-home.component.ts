...
@Component({
  selector: 'CompanySector-home',
  templateUrl: './CompanySector-home.component.html',
  styleUrls: ['./CompanySector-home.component.scss']
})
export class CompanySectorHomeComponent implements AfterViewInit {
