...
@Component({
  selector: 'FormType-home',
  templateUrl: './FormType-home.component.html',
  styleUrls: ['./FormType-home.component.scss']
})
export class FormTypeHomeComponent implements AfterViewInit {
