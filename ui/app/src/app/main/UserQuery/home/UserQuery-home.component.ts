...
@Component({
  selector: 'UserQuery-home',
  templateUrl: './UserQuery-home.component.html',
  styleUrls: ['./UserQuery-home.component.scss']
})
export class UserQueryHomeComponent implements AfterViewInit {
