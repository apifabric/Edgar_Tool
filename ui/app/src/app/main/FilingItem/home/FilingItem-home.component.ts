...
@Component({
  selector: 'FilingItem-home',
  templateUrl: './FilingItem-home.component.html',
  styleUrls: ['./FilingItem-home.component.scss']
})
export class FilingItemHomeComponent implements AfterViewInit {
